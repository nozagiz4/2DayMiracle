...
<body>
   ...
   <div class="container" style="margin-top: 180px;">
        ...
        <div class="row" style="margin-bottom: 30px;">
            ...
            <div class="col-12">
                <img src="img/new year.jpg" alt="Avatar" style="width: 100%; height: 474px;" class=" img1 rounded" >
            </div>
         ...
         <span ><b style=" font-size: 25px;">POPULAR COLLECTION OF IMAGES</b></span>
            <div class="row" style="margin-top: 20px;margin-bottom: 30px;"> 
                <div class="col-6">
                    <a href="newyearcollection.html" style="text-decoration: none;">
                    <div class="card">
                         <img src="img/1.jpg" alt="Avatar" style="width: 100%;  height: auto; " class=" rounded" >
                         <div class="container">
                ...
                <div class="col-6">
                    <div class="card">
                        <img src="img/12345.jpg" alt="Avatar" style="width: 100%; height: auto;" class="rounded" >
                        <div class="container">
        ...
        <div class="row" style="margin-bottom: 30px;">
            ...
            <div class="col-6">
                <div class="card">
                    <img src="img/holiday.jpg" alt="Avatar" style="width: 100%; height: auto;" class="rounded" >
                    <p style=" height: 40px;text-align: center;"><span style=" font-size: 21px; ">Holiday</span> </p>
                </div>
            </div>
            <div class="col-6">
                <div class="card">
                    <img src="img/coldwind.jpg" alt="Avatar" style="width: 100%; height: auto;" class="rounded" >
        ...
        <div class="row" style="margin-top: 20px;margin-bottom: 25px;">
            ...
            <div class="col-4">
                <div class="card">
                    <img src="img/background.jpg" alt="Avatar" style="width: 100%; height: auto;" class="rounded" >
                    <p style=" height: 25px;text-align: center;"><span style=" font-size: 21px; ">Background</span> </p>
                </div>
            </div>
            <div class="col-4">
                <div class="card">
                   <img src="img/nature.jpg" alt="Avatar" style="width: 100%; height: auto;" class="rounded" >
            ...
            <div class="col-4">
                <div class="card">
                   <img src="img/business.jpg" alt="Avatar" style="width: 100%; height: auto;" class="rounded" >
        ...
        <div class="row"style="margin-bottom: 25px;">
            ...
            <div class="col-4">
                <div class="card">
                   <img src="img/education.jpg" alt="Avatar" style="width: 100%; height: auto;" class="rounded" >
            ...
            <div class="col-4">
                <div class="card">
                   <img src="img/sport.jpg" alt="Avatar" style="width: 100%; height: auto;" class="rounded" >
            ...
            <div class="col-4">
                <div class="card">
                    <img src="img/3D.jpg" alt="Avatar" style="width: 100%; height: auto;" class="rounded" >
        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="card">
                   <img src="img/Logo.jpg" alt="Avatar" style="width: 100%; height: auto;" class="rounded" >
            ...
            <div class="col-4">
                <div class="card">
                   <img src="img/food and drink.jpg" alt="Avatar" style="width: 100%; height: auto;" class="rounded" >
            ...
            <div class="col-4">
                <div class="card">
                  <img src="img/MESCELLANEOUS.jpg" alt="Avatar" style="width: 100%; height: auto;" class="rounded" >
        ...
        <div class="row">
            ...
            <div class="col-2">
                <p><b><a href="newyearcollection.html" style="color: gray;text-decoration: none;">2. New year</a> </b></p>
            </div>
            <div class="col-2">
