...
<body>
    ...
    <div class="container" style="margin-top: 180px;">
        <p style=" font-weight: bold; font-size: 28px;">NEWYEAR COLLECTION</p>
                <div class="row">
                    <div class="col-4" >
                        <a href="Detail-image-id-1.html"><img id="1" src="1.jpg" alt="1" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4" >
                        <a href="Detail-image-id-2.html"><img  id="2" src="2.jpg" alt="2" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-3.html"><img id="3" src="3.jpg" alt="3" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4" >
                        <a href="Detail-image-id-4.html"><img id="4" src="4.jpg" alt="4" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4" >
                       <a href="Detail-image-id-5.html"><img id="5" src="5.jpg" alt="5" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-6.html"><img id="6" src="6.jpg" alt="6" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4">
                       <a href="Detail-image-id-7.html"><img id="7" src="7.png" alt="7" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-8.html"><img id="8" src="8.jpg" alt="8" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-9.html"><img id="9" src="9.jpg" alt="9" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4" >
                        <a href="Detail-image-id-10.html"><img id="10" src="10.jpg" alt="10" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-11.html"><img id="11" src="11.png" alt="11" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-12.html"><img id="12" src="12.jpg" alt="12" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4">
                        <a href="Detail-image-id-13.html"><img id="13" src="13.jpg" alt="13" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-14.html"><img id="14" src="14.jpg"14" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-15.html"><img id="15" src="15.png" alt="15" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4">
                        <a href="Detail-image-id-16.html"><img id="16" src="16.jpg" alt="16" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                       <a href="Detail-image-id-17.html"><img id="17" src="17.jpeg" alt="17" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-18.html"><img id="18" src="18.jpg" alt="18" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4">
                     <a href="Detail-image-id-19.html"><img id="19" src="19.jpg" alt="19" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-20.html"><img id="20" src="20.jpg" alt="20" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-21.html"><img id="21" src="21.jpg" alt="21" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>
    ...
    <section style="background-color: rgb(255, 184, 56);padding-top: 30px;margin-top: 100px;">
        <div class="container">
          <div class="row">
            <div class="col-md-2 " >
              <span><b style="color: white; font-size: 33px ;"><a href="index.html"style="color: white;text-decoration: none;"> PIXCAMERA</a></b></span>
            </div>
            <div class="col-md-2">
