         ...
         <div class="row" style="margin: auto;">
            <div class="related">
              <p style=" font-weight: bold; font-size: 26px; margin: auto;">RELATED PICTURES</p>
                <div class="row">
                    <div class="col-4">
                      <a href="Detail-image-id-1.html"><img  src="1.jpg" alt="1" width="100%" height="100%" style=" border-radius: 1.5%;" ></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-5.html"> <img src="5.jpg" alt="5" width="100%" height="100%" style=" border-radius: 1.5%;" ></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-6.html"><img src="6.jpg" alt="6" width="100%" height="100%" style=" border-radius: 1.5%;" ></a>
                    </div>
                </div>
